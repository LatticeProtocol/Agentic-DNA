...
## Proposed Solution
Ship only essential plugins (~1.5MB): obsidian-advanced-canvas + templater-obsidian + optionally obsidian-tasks-plugin. Document remaining 12 as optional. Update setup.sh. **Herb must test Obsidian UX after trimming.**
