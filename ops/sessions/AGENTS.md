...
2. Create session file in `ops/sessions/active/` with minimal frontmatter
...
- **Conflict scan**: Before starting, scan `ops/sessions/active/` for overlapping scopes
...
- Completed sessions move to `ops/sessions/history/YYYY-MM/`
...
Template: `ops/templates/template_session.md`
